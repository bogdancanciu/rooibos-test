...
function undent(...args) {
    ...
    if (Array.isArray(args[0])) {
        ...
        for (let i = 0; i < literals.length; i++) {
            parts.push(literals[i], (_a = expressions[i]) !== null && _a !== void 0 ? _a : '');
        }
        fullText = parts.join('');
    ...
    do {
        ...
        let newline = (_b = match === null || match === void 0 ? void 0 : match[1]) !== null && _b !== void 0 ? _b : '';
        let line = fullText.substring(nextLineStartIndex, match === null || match === void 0 ? void 0 : match.index);
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        line = line.trimEnd();
        //append the newline
        line += newline !== null && newline !== void 0 ? newline : '';
        lines[i] = line;
    }
...
//# sourceMappingURL=undent.js.map